# Live Code Editor: Real-Time Collaborative Code Editor

![Live Code Editor Logo](https://lh3.googleusercontent.com/u/0/drive-viewer/AEYmBYSVYEUB6Eu_ic8-5YK2JKP9szIw-B6ZY6-m8i3preDyPqw6JKhnuMGq8FcDN_o5ZMu5yNDuSZWwa2BjB5UDmqq6WR4K=w1920-h937)
...
### To use Live Code Editor:

1. Go to `https://live-code-editor.onrender.com`
...
5. Live Code Editor requires no registration and works directly in modern web browsers.

## Usage Examples

- Technical interviews - Interviewers can assess candidates by sharing a Live Code Editor room and asking them to solve problems in real time
...
#### To install Live Code Editor for development:
...
```
git clone https://github.com/raunak123455/Live-code-editor-collab.git
```

3. Navigate to the project directory:

```
cd live-code-editor-collab
```
...
Live Code Editor is [MIT LICENCED](https://choosealicense.com/licenses/mit/)
